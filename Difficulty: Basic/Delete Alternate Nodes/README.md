<h2><a href="https://www.geeksforgeeks.org/problems/delete-alternate-nodes/1?page=1&category=Linked%20List&sortBy=difficulty">Delete Alternate Nodes</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a Singly Linked List of size <strong>n</strong>,&nbsp;delete all <strong>alternate</strong> nodes of the list.</span></p>
